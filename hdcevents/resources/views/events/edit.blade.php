    ...
    <div id="event-create-container" class="col-md-6 offset-md-3">
        ...
        <form action="/events/update/{{ $event->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img src="/image/events/{{ $event->image }}" alt="{{ $event->title }}" class="img-preview">
            </div> 

                <div class="form-group">
                    <label for="title">Titulo do evento</label>
                    <input type="text" name="title" id="title" placeholder="Nome do evento" class="form-control" value="{{ $event->title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="city" id="city" placeholder="Nome do local do evento" class="form-control" value="{{ $event->city }}">
                </div>
